...
Automatically detecting the user’s location

Showing nearby places on a map

Filtering recommendations by mood and distance
...
OpenStreetMap Overpass API (places data)

Nominatim API (reverse geocoding)

Styling: CSS (custom UI, responsive layout)
...
📏 Distance-based sorting (Nearest / Popular)
